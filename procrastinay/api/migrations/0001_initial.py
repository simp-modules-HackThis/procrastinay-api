# Generated by Django 2.2.15 on 2020-08-13 04:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Guild',
            fields=[
                ('guild_id', models.UUIDField(default=uuid.uuid4,
        ...
        migrations.CreateModel(
            name='UserTask',
            fields=[
                ('task_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE,
                                                  parent_link=True, primary_key=True, serialize=False, to='api.Task')),
